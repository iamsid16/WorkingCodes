...
void callback(char* topic, byte* payload, unsigned int length) 
{
  ...
  else if(strcmp(((char*)payload), "REL1OFF") == 0)  {digitalWrite(R1,HIGH);}       // L1 OFF 
  else if(strcmp(((char *)payload),"REL1ON") == 0)   {digitalWrite(R1,LOW); }       // L1 ON with 10min delay and then L1
  else if(strcmp(((char*)payload), "REL2OFF") == 0)  {digitalWrite(R2,HIGH);}       // L2 OFF
  else if(strcmp(((char *)payload),"REL2ON") == 0)   {digitalWrite(R2,LOW);}        // L2 ON
  else if(strcmp(((char*)payload),"REL3OFF") == 0)   {digitalWrite(R3,HIGH);}       // F1 OFF
  else if(strcmp(((char *)payload),"REL3ON") == 0)   {digitalWrite(R3,LOW); delay(300000); digitalWrite(R3,HIGH);}       // F1 ON with 5min delay and then F1 OFF
